...
def triton_mx_block_rearrange_2d_K_groups(
    ...
    # Calculate number of column blocks per group
    ...
    total_col_blocks = cumulative_col_blocks[-1]
...
def triton_scale_swizzle_2d_K_groups_parallel(
    ...
    # Find which group this col_block_pid belongs to via vectorized search
    ...
    is_in_group = (col_block_pid >= cumsum_starts) & (col_block_pid < cumsum_ends)
    ...
    local_col_block = tl.sum(tl.where(is_in_group, col_block_pid - cumsum_starts, 0))
